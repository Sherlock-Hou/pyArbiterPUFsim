...
def xorKnackertester(bitzahl, numxor, genauigkeit, genauigkeit2, wieoft, CRParray, timestamp):
    ArbPUFgoal = XORArbPUF(bitzahl, numxor, 'equal')
    #ArbPUFgoal = BentArbPUF(bitzahl, numxor)
...
def xorKnacker(bitzahl, numxor, genauigkeit, genauigkeit2, ArbPUFgoal, wieoft, CRP, timestamp, challenges=None, bin_resp=None):
    res = 0.
    sucess = 0
    oft = 0
    mc_rate = MCError()
...
if __name__ == '__main__':
    xorKnackertester(10, 4, 0.05, 0.01, 10, array([10]), 'Test')
